...
public:
    ...
    bool Init()
    {
        ...
        if (!m_pGround->LoadMesh("C:/Users/sofya/source/repos/lr5 IikG/lesson 28/Content/quad.obj")) {
            return false;
        }
        ...
        m_pNormalMap = new Texture(GL_TEXTURE_2D, "C:/Users/sofya/source/repos/lr5 IikG/lesson 28/Content/normal_map.jpg");
